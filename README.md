...
## OBJECTIVE:  
ServiceNow's objective is to be The Now Platform is the “Platform of Platforms” To facilitate the automation of work across internal and external systems, it is crucial to extend ServiceNow's core vocabulary so it's easier to communicate with those systems. NIEM, the National Information Exchange Model provides a common framework that is used to define how information can be shared between systems, government agencies, and the private sector. It represents a collaborative partnership of agencies and organizations across all levels of government (federal, state, tribal, and local) and with private industry.
